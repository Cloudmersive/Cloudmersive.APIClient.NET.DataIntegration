...
${nuget_cmd} install src/Cloudmersive.APIClient.NET.DataIntegration/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Cloudmersive.APIClient.NET.DataIntegration.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Cloudmersive.APIClient.NET.DataIntegration.dll \
-recurse:'src/Cloudmersive.APIClient.NET.DataIntegration/*.cs' \
-doc:bin/Cloudmersive.APIClient.NET.DataIntegration.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Cloudmersive.APIClient.NET.DataIntegration.dll was created successfully"
fi
